...
export class BitstreamDataService extends IdentifiableDataService<Bitstream> implements SearchData<Bitstream>, PatchData<Bitstream>, DeleteData<Bitstream> {
  ...
  protected genrateSmartDocumentView = 'getMeargePDFByItemID';
  constructor(
  ...
  public _getMeargePDFByItemID(rootid: string, options: FindListOptions = {}, useCachedVersionIfAvailable = false, reRequestOnStale = true, ...linksToFollow: FollowLinkConfig<Bitstream>[]): Observable<RemoteData<Bitstream>> {
    options = Object.assign({}, options, {
      searchParams: [new RequestParam('itemID', rootid)]
    });
    return this.searchBySingle(this.genrateSmartDocumentView, options, useCachedVersionIfAvailable, reRequestOnStale, ...linksToFollow);

  }

  searchBySingle(searchMethod: string, options: FindListOptions = {}, useCachedVersionIfAvailable = true, reRequestOnStale = true, ...linksToFollow: FollowLinkConfig<Bitstream>[]): Observable<RemoteData<Bitstream>> {
