 ...
 */
export abstract class BaseItemDataService extends IdentifiableDataService<Item> implements SearchData<Item>, CreateData<Item>, PatchData<Item>, DeleteData<Item> {
  ...
  public getSearchByHref(searchMethod: string, options?: FindListOptions, ...linksToFollow: FollowLinkConfig<Item>[]): Observable<string> {
    return this.searchData.getSearchByHref(searchMethod, options, ...linksToFollow);
  }
  searchBySingle(searchMethod: string, options: FindListOptions = {}, useCachedVersionIfAvailable = true, reRequestOnStale = true, ...linksToFollow: FollowLinkConfig<Item>[]): Observable<RemoteData<Item>> {
  ...
  public _getItemByCino(rootid: string, options: FindListOptions = {}, useCachedVersionIfAvailable = false, reRequestOnStale = true, ...linksToFollow: FollowLinkConfig<Item>[]): Observable<RemoteData<Item>> {
    options = Object.assign({}, options, {
      searchParams: [new RequestParam('cino', rootid)]
    });
    return this.searchBySingle('getItemByCino', options, useCachedVersionIfAvailable, reRequestOnStale, ...linksToFollow);
