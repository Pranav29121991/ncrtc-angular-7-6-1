...
import { MaxLengthValidator, MinLengthValidator, UntypedFormGroup } from '@angular/forms';
import {
...
export class EPersonFormComponent implements OnInit, OnDestroy {
  ...
  initialisePage() {
    ...
    observableCombineLatest([
      ...
      this.translateService.get(`${this.messagePrefix}.mobileno`),
      this.translateService.get(`${this.messagePrefix}.email`),
      this.translateService.get(`${this.messagePrefix}.canLogIn`),
      this.translateService.get(`${this.messagePrefix}.requireCertificate`),
      this.translateService.get(`${this.messagePrefix}.emailHint`),
    ]).subscribe(([firstName, lastName,password, mobileno, email, canLogIn, requireCertificate, emailHint]) => {
      ...
      this.mobileno = new DynamicInputModel({
        id: 'mobileno',
        label: mobileno,
        name: 'mobileno',
        inputType:'number',
        ...
        errorMessages:{
          ...
          maxLength: 'error.validation.mobileMaxLength',
          minLength: 'error.validation.mobileMinLength'
        }
      });
      ...
      this.subs.push(this.epersonService.getActiveEPerson().subscribe((eperson: EPerson) => {
        ...
        this.formGroup.patchValue({
          ...
          mobileno: eperson != null ? eperson.firstMetadataValue('eperson.mobileno') : '',
    ...
    const editedEperson = Object.assign(new EPerson(), {
      ...
      metadata: {
        ...
        'eperson.lastname': [
          ...
          {
            value: (this.mobileno.value ? this.mobileno.value : ePerson.firstMetadataValue('eperson.mobileno'))
          },
        ],
      },
