...
import {
  documentTypeRegistryReducer,
  DocumentTypeRegistryState
} from './admin/admin-registries/documenttype/documenttype-registry.reducers';
export interface AppState {
  ...
  documentTypeRegistry: DocumentTypeRegistryState;
}
...
export const appReducers: ActionReducerMap<AppState> = {
  ...
  documentTypeRegistry: documentTypeRegistryReducer,
};
