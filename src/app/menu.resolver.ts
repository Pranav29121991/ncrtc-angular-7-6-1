  ...
  createImportMenuSections() {
    ...
    observableCombineLatest([
      ...
      this.menuService.addSection(MenuID.ADMIN, {
        ...
        model: {
          type: MenuItemType.LINK,
          text: 'menu.section.batch.upload',
  ...
  createSiteAdministratorMenuSections() {
    this.authorizationService.isAuthorized(FeatureID.AdministratorOf).subscribe((authorized) => {
      const menuList = [
        ...
        {
          id: 'productivityreport',
          active: true,
          visible: authorized,
          model: {
            type: MenuItemType.LINK,
            text: 'menu.section.productivityreport',
            link: 'productivityreport'
          } as LinkMenuItemModel,
          icon: 'chart-pie',
          index: 14
        },
        ...
        },
        {
          ...
          id: 'registries_documenttype',
          parentID: 'registries',
          active: false,
          visible: authorized,
          model: {
            type: MenuItemType.LINK,
            text: 'menu.section.registries_documenttype',
            link: 'admin/registries/documenttype'
          } as LinkMenuItemModel,
        }, {
          id: 'registries_documenttypetemplet',
          parentID: 'registries',
          active: false,
          visible: authorized,
          model: {
            type: MenuItemType.LINK,
            text: 'menu.section.registries_documenttypetemplet',
            link: 'admin/registries/documentypetree-templete'
          } as LinkMenuItemModel,
        },
