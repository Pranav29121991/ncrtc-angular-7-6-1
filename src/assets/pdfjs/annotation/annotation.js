...
pdfwheel.Annotation.prototype.saveFabricCanvas = function(page_number) {
	...
	var page_id = this.fabric_annos_id_tag + page_number.toString();
	var fabric_annotation_id = this.PDFViewerApplication.baseUrl + '_page_fabric_' + page_number.toString();
...
pdfwheel.Annotation.prototype.readFabricAnnotationsForPage = function(page_number) {
	var this_page_id = this.PDFViewerApplication.baseUrl + '_page_fabric_' + page_number.toString();
...
pdfwheel.Annotation.prototype.setOnePageAnnotation = function(page_content, page_number) {
	var annotation_id = this.PDFViewerApplication.baseUrl + '_page_' + page_number.toString();
...
pdfwheel.Annotation.prototype.readFileAnnotations = function() {
	...
	localStorage.setItem(this.PDFViewerApplication.baseUrl+'/myAnnotation',JSON.stringify(this_file_annotations));
...
pdfwheel.Highlight.prototype.getMouseUpPos = function() {
	...
	for (var data_page_number in spans_dict) {
		...
		if (spans.length > 500) {
			...
			var highlight_page_id = this.PDFViewerApplication.baseUrl + '_page_' + data_page_number;
			this.annotation_id = this.PDFViewerApplication.baseUrl + '_page_' + data_page_number;
...
function addScatchPadToAnnotation(node) {
	...
	console.log(node_id);
	localStorage.setItem('addednote',this.PDFViewerApplication.baseUrl+ '?' + node_id)
}
